package com.cimcitech.mginscription.widget;
...
public class CustomScrollView extends ScrollView {
    ...
    public void initView(Context context) {
        ...
        arrowImageView = headView.findViewById(R.id.head_arrowImageView);
        ...
        moreProgressBar = footView.findViewById(R.id.pull_to_refresh_progress);
        loadMoreView = footView.findViewById(R.id.load_more);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (state != REFRESHING && state != LOADING && isRecored) {
                    if (state == RELEASE_To_REFRESH) {
                        if ((tempY - startY) > 0 && (tempY - startY) / RATIO < headContentHeight + 10) {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case DONE:
                ...
                progressBar.setVisibility(View.GONE);
                arrowImageView.clearAnimation();
                arrowImageView.setImageResource(R.mipmap.pull_refresh_arrow);
                tipsTextview.setText("下拉可以刷新");
                lastUpdatedTextView.setVisibility(View.GONE);
                isRecored = false;
                break;
